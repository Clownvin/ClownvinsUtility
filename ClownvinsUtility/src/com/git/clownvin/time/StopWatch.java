...
public class StopWatch {
   ...
   /**
    * Restarts this {@code StopWatch} in a paused state with the specified timer length.
    * <p>
    * Starting paused is useful for calling {@link #runForDuration(Runnable)},
    * since it will allow the code executing to chose when to start and stop this
    * {@code StopWatch} without having to immediately pause it itself to achieve
   ...
   /**
    * Will continuously execute the {@link Runnable} specified until this {@code StopWatch}es
    * timer is expired.
    * <p>This is useful for executing code in succession, but only for a while.
    * When used in conjunction with pausing, you can also guarantee specific that code executes for
    * approximately the length of the timer
    * <p>If you need very precise control over what segments of code affect this {@code StopWatch}, you can
    * call this method while in a paused state. Doing this means that you will need to manually unpause this
    * {@code StopWatch} inside the specified {@code Runnable}.
    * 
    * @param code the code to be executed for the remaining duration of this {@code StopWatch}.
    * @return this {@code StopWatch}, for method chaining
    * @since 1.0
    */
   ...
   /**
    * Sets the timer length of this {@code StopWatch} and notifies the alarm to start ticking.
   ...
   /**
    * Starts this {@code StopWatch}. Effectively calls {@link #start(long) start(0)}.
    * @return this {@code StopWatch}, for method chaining
    * @since 1.0
    */
    ...
    * <p>Will throw an {@code IllegalStateException} if this {@code StopWatch}
    * is already started.
    * 
    * @param timerLength new timer length
    * @return this {@code StopWatch}, for method chaining
    ...
    * <p>Will unpause if paused, and will throw an {@code IllegalStateException} if
   ...
   /**
    * Simply calls {@link #timeElapsed(TimeUnit) timeElapsed(TimeUnit.MILLISECONDS)}.
    * 
   ...
   /**
    * Returns the time since the start, after converting it from nanoseconds to 
    * the specified {@link TimeUnit}.
    * 
